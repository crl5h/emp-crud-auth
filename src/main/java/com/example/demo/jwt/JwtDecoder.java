...
public class JwtDecoder {
    ...
    /**
     * Decodes the jwt from the client and verifies it to extract valuable information
     * @param token JWT token string to be decoded and verified
     * @return DecodedJWT object from auth0
     * @throws JWTVerificationException If the JWT verification fails due to an invalid token or signature.
     */
